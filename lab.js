...
favoriteThings.show ='strangerThings'
...
return newUtah + newCalifornia + newTexas + newArizona;
...
let array= []
array.push(newCarb, newFat, newProtein)
}
const nutrients ={
  carb : 'bread',
  fat: "butter",
...
class Wizard{
  ...
  let Wizard2 = new Wizard('bella', 5, 'abracadabra')
